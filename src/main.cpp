...
void setupSimulator(CPU* cpu, DRAM *ram1, DRAM *ram2){ // Sets up the instruction memory with the instructions
    ...
    ram1->writeWordAtAddr(80, 0b11001000101000001010000000000001); // 24
    ...
    ram1->writeWordAtAddr(104, 0b11001010000001001010000000000000); // 30
    ...
    ram1->writeWordAtAddr(120, 0b11111110101001000010100000100011); // 35
    ram1->writeWordAtAddr(124, 0b11110110000000000000000010000000); // 36

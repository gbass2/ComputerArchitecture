...
void setupSimulator(DRAM *ram1, DRAM *ram2){ // Sets up the instruction memory with the instructions
    ...
    // A5_CPU1
    ram2->writeWordAtAddr(512, 0b11001000100000001000000001111111); //2
    ram2->writeWordAtAddr(516, 0b11000100011101001000100000000000); //3
    ram2->writeWordAtAddr(520, 0b11000100001101001000000100000000); //4
    ram2->writeWordAtAddr(524, 0b11001000001000001000000001000000); //5
    ram2->writeWordAtAddr(528, 0b11001000101000000000000000000000); //6
    ram2->writeWordAtAddr(532, 0b11000100010101000010010101111111); //7
    ram2->writeWordAtAddr(536, 0b11000100100110000010010101111111); //8
    ram2->writeWordAtAddr(540, 0b11000000101010100010010011111111); //9
    ram2->writeWordAtAddr(544, 0b11001001101000000000110001100000); //11
    ram2->writeWordAtAddr(548, 0b11110110000000000000000001000100); //12
    ram2->writeWordAtAddr(552, 0b11000110100000111010010100001100); //13
    ram2->writeWordAtAddr(556, 0b11110110000000000000000011000100); //14
    ram2->writeWordAtAddr(560, 0b11001000101000000000000000000000); //16
    ram2->writeWordAtAddr(564, 0b11000100000110000010010101111111); //17
    ram2->writeWordAtAddr(568, 0b11110110000000000000001111000100); //18
    ram2->writeWordAtAddr(572, 0b11000000101010100010000011111111); //20
    ram2->writeWordAtAddr(576, 0b11001001101000000000110001100000); //21
    ram2->writeWordAtAddr(580, 0b11000110000100111010010101110100); //22
    ram2->writeWordAtAddr(584, 0b11110110000000000000001100100100); //23
    ram2->writeWordAtAddr(588, 0b11110110000000000000000010100100); //25
    ram2->writeWordAtAddr(592, 0b11101100101001000000000000000000); //27
    ram2->writeWordAtAddr(596, 0b11001000101000001010101101010011); //28
    ram2->writeWordAtAddr(600, 0b11000001101010100010010011111111); //29
    ram2->writeWordAtAddr(604, 0b11001000011000000000001001100000); //30
    ram2->writeWordAtAddr(608, 0b11001101101000011010001101000000); //31
    ram2->writeWordAtAddr(612, 0b11000000011010100010000011111111); //32
    ram2->writeWordAtAddr(616, 0b11001101101000011010001100000000); //33
    ram2->writeWordAtAddr(620, 0b11001001101010011010100000000000); //34
    ram2->writeWordAtAddr(624, 0b11001100101000001010110100000000); //35
    ram2->writeWordAtAddr(628, 0b11000000101010001010000000000000); //36
    ram2->writeWordAtAddr(632, 0b11001001101000000000111111111111); //37
    ram2->writeWordAtAddr(636, 0b11000110001010001010110100010100); //38
    ram2->writeWordAtAddr(640, 0b11110110000000000000001000010100); //39
    ram2->writeWordAtAddr(644, 0b11110110000000000000000010100100); //41
    ram2->writeWordAtAddr(648, 0b11101100101001000000000000000000); //43
    ram2->writeWordAtAddr(652, 0b11001000101000001010101101010011); //44
    ram2->writeWordAtAddr(656, 0b11000001101010100010010011111111); //45
    ram2->writeWordAtAddr(660, 0b11001000011000000000001001100000); //46
    ram2->writeWordAtAddr(664, 0b11001101101000011010001101000000); //47
    ram2->writeWordAtAddr(668, 0b11000001011010100010000011111111); //48
    ram2->writeWordAtAddr(672, 0b11001101101000011010101100000000); //49
    ram2->writeWordAtAddr(676, 0b11001001101010011010100000000000); //50
    ram2->writeWordAtAddr(680, 0b11001100101000001010110100000000); //51
    ram2->writeWordAtAddr(684, 0b11000000101010001010000000000000); //52
    ram2->writeWordAtAddr(688, 0b11000100011010000010010101111111); //53
    ram2->writeWordAtAddr(692, 0b11000000101010000010001101111111); //54
    ram2->writeWordAtAddr(696, 0b11001000101010101010001000000000); //55
    ram2->writeWordAtAddr(700, 0b11101101101011100000000000000000); //56
    ram2->writeWordAtAddr(704, 0b11001001101000011010101100110101); //57
    ram2->writeWordAtAddr(708, 0b11000001011010100010010011111111); //58
    ram2->writeWordAtAddr(712, 0b11001100011000010110001101000000); //59
    ram2->writeWordAtAddr(716, 0b11000001011010100010000011111111); //60
    ram2->writeWordAtAddr(720, 0b11001100011000000110101100000000); //61
    ram2->writeWordAtAddr(724, 0b11001101101000011010001100000000); //62
    ram2->writeWordAtAddr(728, 0b11000100000000011010010100000000); //63
    ram2->writeWordAtAddr(732, 0b11110110000000000000000001110100); //64
    ram2->writeWordAtAddr(736, 0b11000000101010000010000011111111); //66
    ram2->writeWordAtAddr(740, 0b11001000101000001010100000000000); //67
    ram2->writeWordAtAddr(744, 0b11000100000110000010010101111111); //68
    ram2->writeWordAtAddr(748, 0b11110110000000000000001111000100); //69
    ram2->writeWordAtAddr(752, 0b11110110000000000000001011110100); //71
    ram2->writeWordAtAddr(756, 0b11000000101010000010010011111111); //73
    ram2->writeWordAtAddr(760, 0b11001000101000001010100000000000); //74
    ram2->writeWordAtAddr(764, 0b11000100100110000010010101111111); //75
    ram2->writeWordAtAddr(768, 0b11110110000000000000000001000100); //76
    ram2->writeWordAtAddr(772, 0b11000000101001000010001011111111); //78
    ram2->writeWordAtAddr(776, 0b11000000001001001000000110000000); //79
    ram2->writeWordAtAddr(780, 0b11000001000001001000001110000000); //80
    ram2->writeWordAtAddr(784, 0b11001000100000001000000001000000); //81
    ram2->writeWordAtAddr(788, 0b11100110000000010000000000000000); //82
}
